...
public class SmsClientTests {
    ...
    public void testAliyunSmsClient_sendSms() throws Throwable {
        ...
        String apiTemplateId = "SMS_207945135";
        // 调用
        SmsSendRespDTO sendRespDTO = client.sendSms(sendLogId, mobile, apiTemplateId, Lists.newArrayList(new KeyValue<>("code", "1024")));
        // 打印结果
    ...
    public void testHuaweiSmsClient_sendSms() throws Throwable {
        ...
        List<KeyValue<String, Object>> templateParams = Lists.newArrayList(new KeyValue<>("code", "1024"));
        // 调用
